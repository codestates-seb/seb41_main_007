                ...
                .andDo(document(
                        ...
                        responseFields(
                                List.of(
                                        ...
                                        fieldWithPath("orderByLikeCount[*].rating").type(JsonFieldType.NUMBER).description("별점"),
                                        ...
                                        fieldWithPath("orderByProductId[*].rating").type(JsonFieldType.NUMBER).description("별점"),
                                        ...
                                        fieldWithPath("orderBySoldCount[*].rating").type(JsonFieldType.NUMBER).description("별점"),
