...
<aside>
✅ 아래 표의 항목을 따라 여러분의 에피소드를 기록해보세요.

여러분의 에피소드를 작성해보면서 나의 스토리를 정리하는 시간을 가져보시길 바랄게요!
또한, 이번 과제는 이력서 Summary(About me) 작성과 면접 준비에 도움이 되실 거에요.

에피소드 브레인스토밍 과제의 정답은 없습니다. 

여러분의 에피소드 2개를 기록해서 STAR 기법에 기반하여 정리하고, 
여러분 이야기의 전달력을 강화하는 시간을 가져보세요. (60분)
